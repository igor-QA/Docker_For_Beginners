...
```
### Важно : 
Хочу заметить, что в Docker fail нужно учитывать **пробелы** 2 отсупа.
...
### Заключение
В этой статье не были упомянуты такие инструкции, как USER, ONBUILD, STOPSIGNAL, SHELL, и HEALTHCHECK.

## 10 команд для Docker часто встречающихся. Поехали.
